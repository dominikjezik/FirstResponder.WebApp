...
public class ChangeUsersInCourseCommandHandler : IRequestHandler<ChangeUsersInCourseCommand>
{
    ...
    {
        await _coursesRepository.ChangeUsersInCourse(request.ChangeUsersInCourseDTO.CourseId, request.ChangeUsersInCourseDTO.CheckedOnUserIds, request.ChangeUsersInCourseDTO.CheckedOffUserIds);
    }
}